 ...
 * @since ?
 */
class skh_ET_Builder_Module_Icon extends ET_Builder_Module {
	/**
	 * Holds icon selector.
	 *
	 * @var string
	 */
	public static $shortcode = 'et_pb_icon';
	...
	public function init() {
		$this->name                   = et_builder_i18n( 'Stack Icon'); 
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$output = sprintf(
			'<span class="et_pb_icon_wrap %1$s icon_aligned">%2$s%4$s%5$s%3$s</span>',
		...
		$output = sprintf(
			'<div%3$s class="%2$s div-aligned icon-aligned">
				%1$s
			</div>',
			$output,
